...
> All registered routes require the seed in the request header: `x-user-seed: <seed>`
...
| `GET`    | `/cards`                 |                                                           | `name, type, rarity, min_attack, max_attack, min_defense, max_defense, sort_by` | Get information on all cards                                   |
| `POST`   | `/battle`                | `{ "cards": [...], "difficulty": 1 }`                     |                                                                                 | Play a battle (difficulty 1-10)                                |
